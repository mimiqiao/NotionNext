...
export const BlogItem = props => {
  ...
  return <div key={post.id} className="h-42 my-6 pb-12 border-b dark:border-gray-800" >
        ...
        <div className='block'>
            <Link href={`${siteConfig('SUB_PATH', '')}/${post.slug}`} className='inline-block rounded-sm text-primary-600 text-xs dark:border-gray-800 border hover:text-red-400 transition-all duration-200 hover:border-red-300 h-9 leading-8 px-5'>
